...
<head>
    ...
    echo'歡迎ROOT登入';
    echo '
    <a href="login.php"><button class="btn btn-large btn-primary" type=submit>登出</button> </a>';
    }
    else
    {
    echo'你不是root';
...
echo "<div class=$h7>
    ...
    <tr>
        ...
        if ($_GET['order']==2) {
        echo "
        <td width=2%><a href=management.php?order =1>編號</a></td>";
        }
        else {
        echo "
        <td width=2%><a href=management.php?order =2>編號</a></td>";
        }
        if ($_GET['order']==4) {
        echo "
        <td width=5%><a href=management.php?order =3>帳號</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =4>帳號</a></td>";
        }
        if ($_GET['order']==6) {
        echo "
        <td width=5%><a href=management.php?order =5>密碼</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =6>密碼</a></td>";
        }
        if ($_GET['order']==8) {
        echo "
        <td width=5%><a href=management.php?order =7>姓名</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =8>姓名</a></td>";
        }
        if ($_GET['order']==10) {
        echo "
        <td width=5%><a href=management.php?order =9>電話</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =10>電話</a></td>";
        }
        if ($_GET['order']==12) {
        echo "
        <td width=5%><a href=management.php?order =11>地址</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =12>地址</a></td>";
        }
        if ($_GET['order']==14) {
        echo "
        <td width=5%><a href=management.php?order =13>檔案</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =14>檔案</a></td>";
        }
        if ($_GET['order']==16) {
        echo "
        <td width=5%><a href=management.php?order =15>時間</a></td>";
        }
        else {
        echo "
        <td width=5%><a href=management.php?order =16>時間</a></td>";
        }
