...
<!--內文-->
    <div class=container>
      ...
      <h1>沖繩</h1></div>
            <p class=lead><code>地理</code>和<code>氣候</code>.
<!--<p>Back to <a href="/bs3/Examples?name=sticky-footer">the default sticky footer</a> minus the navbar.
-->
</div>
                             <div class=container>
                             <div class=jumbotron>
                            <h1>Hello, 沖繩<!</h1>
                            <p>以沖繩群島為中心，此外還包括宮古群島、八重山群島等島嶼。<br>
							</p>
