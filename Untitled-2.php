        ...
        <div class="container theme-showcase" role=main>
            <div class=jumbotron>
                ...
                <p>This is a template for a simple marketing or informational website. It includes a large callout called a jumbotron and three supporting pieces of content. Use it as a starting point to create something more unique.
                    <p><a href=# class="btn btn-primary btn-lg" role=button>Learn more &raquo;</a></div>
                ...
                <p>
                    ...
                    <p>
                        ...
                        <p>
                            ...
                            <div class=page-header>
                                <h1>Thumbnails</h1></div><img data-src=holder.js/200x200 class=img-thumbnail alt="A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera">
                            <div class=page-header>
                                <h1>Labels</h1></div>
                            ...
                            <p><span class="label label-default">Default</span> <span class="label label-primary">Primary</span> <span class="label label-success">Success</span> <span class="label label-info">Info</span> <span class="label label-warning">Warning</span> <span class="label label-danger">Danger</span>
                                <div class=page-header>
                                    <h1>Badges</h1></div>
                                <p><a href=#>Inbox <span class=badge>42</span></a>
                                    <ul class="nav nav-pills" role=tablist>
                                        <li role=presentation class=active><a href=#>Home <span class=badge>42</span></a>
                                            <li role=presentation><a href=#>Profile</a>
                                                <li role=presentation><a href=#>Messages <span class=badge>3</span></a></ul>
                                    <div class=page-header>
                                        <h1>Dropdown menus</h1></div>
                                    <div class="dropdown theme-dropdown clearfix"><a id=dropdownMenu1 href=# class="sr-only dropdown-toggle" data-toggle=dropdown role=button aria-expanded=false>Dropdown <span class=caret></span></a>
                                                ...
                                                <li role=presentation><a role=menuitem tabindex=-1 href=#>Another action</a>
                                                    <li role=presentation><a role=menuitem tabindex=-1 href=#>Something else here</a>
                                                        <li role=presentation class=divider>
                                                            <li role=presentation><a role=menuitem tabindex=-1 href=#>Separated link</a></ul>
                                    </div>
                                    <div class=page-header>
                                        <h1>Navs</h1></div>
                                    <ul class="nav nav-tabs" role=tablist>
                                        <li role=presentation class=active><a href=#>Home</a>
                                            <li role=presentation><a href=#>Profile</a>
                                                <li role=presentation><a href=#>Messages</a></ul>
                                    <ul class="nav nav-pills" role=tablist>
                                        <li role=presentation class=active><a href=#>Home</a>
                                            <li role=presentation><a href=#>Profile</a>
                                                <li role=presentation><a href=#>Messages</a></ul>
                                    ...
                                    <nav class="navbar navbar-default">
                                        <div class=container>
                                            <div class=navbar-header>
                                                <button type=button class="navbar-toggle collapsed" data-toggle=collapse data-target=.navbar-collapse> <span class=sr-only>Toggle navigation</span> <span class=icon-bar></span> <span class=icon-bar></span> <span class=icon-bar></span> </button> <a class=navbar-brand href=#>Project name</a></div>
                                                    ...
                                                    <li class=list-group-item>Dapibus ac facilisis in
                                                        <li class=list-group-item>Morbi leo risus
                                                            <li class=list-group-item>Porta ac consectetur ac
                                                                <li class=list-group-item>Vestibulum at eros</ul>
                                        </div>
                                        <div class=col-sm-4>
                                    ...
                                    <div id=carousel-example-generic class="carousel slide" data-ride=carousel>
                                        ...
                                        <div class=carousel-inner role=listbox>
                                            <div class="item active"><img data-src="holder.js/1140x500/auto/#777:#555/text:First slide" alt="First slide"></div>
                                            <div class=item><img data-src="holder.js/1140x500/auto/#666:#444/text:Second slide" alt="Second slide"></div>
