            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <form role="form" name="product_class" method="post" action="product_new_add.php" enctype="multipart/form-data" action="adduser.php">
                        ...
                        <div class="form-group">
                            <label>產品價格</label>
                            <input type="text" name="product_price" class="form-control" id="exampleInputEmail1" placeholder="輸入產品價格">
                        </div>
                        <div class="form-group">
                            <label>產品優惠價</label>
                            <input type="text" name="product_sale_price" class="form-control" id="exampleInputEmail1" placeholder="輸入產品優惠價">
                        </div>
                        <div class="form-group">
                            <label>產品資訊</label>
                            <textarea name="product_text" class="form-control" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                            <label>檔案上傳1</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="product_display" class="form-control">
                                <option name="product_display[]"  selected="selected">N</option>                             
                                <option name="product_display[]" >Y</option>
