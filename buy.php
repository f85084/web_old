...
<div class="frame">
    <div class="row">
      <span class="thumbnail"><img data-src="holder.js/100%x200" alt="100%x200" src="data:image/svg+xml;base64," data-holder-rendered="true" style="height: 200px; width: 100%; display: block;"></span>
      <div class="col-xs-6-a col-sm-3-a">
        <div class="thumbnail">
          <div class="caption">
            <h3>Thumbnail label</h3>
                        <h5>價錢：</h5>
                        <h5>容量：</h5>            
                        <p class="over">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
