...
<head>
    ...
    <link href=css/index/css1020.css rel=stylesheet>
    <!--[if lt IE 9]><script src=~/Scripts/AssetsBS3/ie8-responsive-file-warning.js></script><![endif]-->
    <script src=css/index/ie-emulation-modes-warning.js></script>
    ...
    <body>
            ...
            <div class="row row-offcanvas row-offcanvas-right">
                <div class="col-xs-12 col-sm-9">
                    <p class="pull-right visible-xs">
                        ...
                        <div class=jumbotron>
                            <h1>Hello, world!</h1>
                            <p>This is an example to show the potential of an offcanvas layout pattern in Bootstrap. Try some responsive-range viewport sizes to see it in action.</div>
                        <div class=row>
        ...
        <script src=css/index/ie10-viewport-bug-workaround.js></script>
        <script src=css/index/offcanvas.js></script>